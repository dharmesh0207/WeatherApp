package com.wheatherapp.view.ui.fragments
...
import com.wheatherapp.utilities.WEBVIW_PATH
import com.wheatherapp.utilities.changeColor
...
class WeatherMapsFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnCameraMoveListener,
    ...
    private fun resetICOn() {
        ivHelp.changeColor(ContextCompat.getColor(requireActivity().applicationContext, R.color.white))
        ivBookMark.changeColor(ContextCompat.getColor(requireActivity().applicationContext, R.color.white))
        ivExploreWeather.changeColor(
            ContextCompat.getColor(
                requireActivity().applicationContext,
                R.color.white
